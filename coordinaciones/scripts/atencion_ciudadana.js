const progInfo = [
  {
    ...
    objetivo:
      "Brindar apoyos económicos a personas que requieren cubrir gastos médicos, medicamentos o servicios funerarios.",
    descripcion:
      "Este programa está diseñado para apoyar a quienes enfrentan dificultades para costear servicios relacionados con la salud o emergencias familiares. Se otorgan apoyos económicos parciales para estudios de laboratorio, medicamentos, atención médica o gastos funerarios, de acuerdo con un estudio socioeconómico.",
  },

  {
    ...
    objetivo:
      "Entregar insumos básicos a personas y familias en situación de vulnerabilidad a través de donaciones.",
    descripcion:
      "A través de Apoyos en Especie, el DIF Saltillo entrega artículos esenciales como ropa, alimentos no perecederos, pañales (infantiles y de adulto), productos de higiene personal, leche, pan, juguetes y más. Estas donaciones representan un alivio inmediato para quienes atraviesan momentos difíciles.",
  },
];
